...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'user_profile_userprofile', 'username',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'user_profile_userprofile', 'username')
    ...
    models = {
        ...
        u'user_profile.userprofile': {
            ...
            'username': ('django.db.models.fields.SlugField', [], {'max_length': '32', 'blank': 'True'})
        }
    }
